<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" width="80" align="center" prop="noticeId" />
      <el-table-column label="标题" show-overflow-tooltip="true" align="center" prop="noticeTitle" />

      <el-table-column label="内容" show-overflow-tooltip="true" align="center" prop="noticeContent" />
      ...
      <el-table-column label="类型" width="80" align="center" prop="noticeType">
        <template slot-scope="scope">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-form-item label="公告附件">
            <fileUpload v-model="form.noticeMultipart"/>
          </el-form-item>
