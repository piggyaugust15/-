...
export default {
  ...
  methods: {
    ...
    // getPassed() {
    //   getUsersArticleByWays(0).then((response) => {
    //     this.passedList = response.rows;
    //     console.log("passed", response);
    //   });
    // },
    // getinProgress() {
    //   getUsersArticleByWays(2).then((response) => {
    //     this.inProgressList = response.rows;
    //     console.log("ing", response);
    //   });
    // },
    // getFailed() {
    //   getUsersArticleByWays(1).then((response) => {
    //     this.failedList = response.rows;
